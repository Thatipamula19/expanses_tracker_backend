...
export class CategoriesService {
    ...
    async getCategories() {
        try {
            ...
            throw new InternalServerErrorException(error?.message ?? 'Failed to get categories');
        }
    }
    ...
    async getCategory(categoryId: string) {
        try {
            ...
            if (!category) {
                throw new InternalServerErrorException(`Category with id ${categoryId} not found`);
            }
            return {
            ...
            throw new InternalServerErrorException(error?.message ?? 'Failed to get category');
        }
    }
    ...
    async addCategory(addCategoryDto: AddCategoryDto) {
        try {
            ...
            throw new InternalServerErrorException(error?.message ?? 'Failed to add category');
        }
    }
