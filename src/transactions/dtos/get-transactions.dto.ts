...
export class GetTransactionsDto {
    ...
    @IsOptional()
    @IsEnum(DateRangePeriod, { message: 'period must be one of: today, this_week, this_month, last_month, last_3_months' })
    ...
    @IsOptional()
    @IsEnum(TransactionType, { message: 'transaction_type must be either income or expense' })
